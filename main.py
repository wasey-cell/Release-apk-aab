...
class MainScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        title_label = MDLabel(
            text="[font=WinkyRough.ttf][size=60] X[color=#FF6B6B]O[/color]X [color=#4ECDC4]G[/color][color=#45B7D1]A[/color][color=#96CEB4]M[/color][color=#FFEAA7]E[/color] [/size][/font]",
            halign="center",
            markup=True,
            theme_text_color="Custom",
            text_color=(1, 1, 1, 1)
        ...
        btn1_text = MDLabel(
            text="[b] VS AI[/b]\n[size=25]Challenge the Bot![/size]",
            markup=True,
            halign="left",
            valign='middle' ,
            theme_text_color="Custom",
        ...
        btn2_text = MDLabel(
            text="[b]2 PLAYERS[/b]\n[size=25]   Battle Your Friend![/size]",
            markup=True,
            halign="left",
            valign='middle',
            theme_text_color="Custom",
...
class set_diff(MDScreen):
    def __init__(self, **kwargs):
        ...
        btn1 = MDCard(
            ...
            md_bg_color=[0.4, 0.8, 0.4, 0.9],  # Green for easy
            ripple_behavior=True
        )
        ...
        btn1_text = MDLabel(
            text="[b]EASY[/b]\n[size=25]  Beginner Friendly![/size]",
            markup=True,
            halign="left",
            valign="middle",
            theme_text_color="Custom",
        ...
        btn2_text = MDLabel(
            text="[b]MEDIUM[/b]\n[size=25]  Balanced Challenge![/size]",
            markup=True,
            halign="left",
            valign="middle",
            theme_text_color="Custom",
